    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity serverHttpSecurity) {
        serverHttpSecurity
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/api/v1/auth/reset-password-otp").permitAll()
                        .pathMatchers("/api/v1/auth/send-registration-otp").permitAll()
                        .pathMatchers("/api/v1/auth/verify-registration-otp").permitAll()
                        .pathMatchers("/api/v1/auth/register-with-otp").permitAll()
